    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- Content Wrapper. Contains page content -->
            <div class="content-wrapper">
                ...
                <h1>Add<small>New Station</small></h1>
                <ol class="breadcrumb">
                ...
                <section class="col-md-8 col-md-offset-2 col-sm-12">
                    <div class="row">
                        <div class="register-box-body">
                            <h3 class="login-box-msg">Add New Station</h3>
                            <!--start form-->
                            <form class="form-horizontal" action="_backend_addStations.php" method="POST">
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="name">Station Name</label>
                                <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-offset-4">
                        <button style="border-radius: 5px;" name="subAdmin" type="submit" class="btn btn-warning btn-block btn-flat">Add New Station</button>
                        </div>
                    </div>
                </form>
                <!--End form-->
