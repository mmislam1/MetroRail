...
session_start();
  ...
  $sql = "select * from admin where permission=0";
  ...
  <html>
      <head>
          ...
          <title>Metro | adminDetails</title>
      ...
      <body class="hold-transition skin-blue sidebar-mini">
          ...
          <!-- Content Wrapper. Contains page content -->
              <div class="content-wrapper">
                  ...
                  <h1>Metro<small>AdminDetails</small></h1>
                  <ol class="breadcrumb">
              ...
              <section class="col-md-10 col-md-offset-1 col-sm-12">
                  <div class="row">
                      <div class="register-box-body">
                          <h3 class="login-box-msg">Admin Details</h3>
                          
                          <form action="_backend_adminList.php" method="POST">
                            ...
                            <?php 
                              ...
                              "<tr>
                                ...
                                <td>".$email."</td> 
                                <td>".$designation."</td>
                               <td><button class='btn btn-danger'  type ='submit' name='delete' value=".$email.">Delete </button></td>
                              </tr>";
                              }
