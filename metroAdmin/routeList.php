      ...
      <body class="hold-transition skin-blue sidebar-mini">
          ...
          <!-- Content Wrapper. Contains page content -->
              <div class="content-wrapper">
                  ...
                  <h1>Metro<small>Route List</small></h1>
                  <ol class="breadcrumb">
              ...
              <section class="col-md-10 col-md-offset-1 col-sm-12">
                  <div class="row">
                      <div class="register-box-body">
                          <h3 class="login-box-msg">Route List</h3>        
                          <form action="_backend_routeList.php" method="POST">
                              ...
                              $name=$row['route_name'];
                                ...
                                "<tr>
                                  <td>".$id."</td>
                                  <td>".$name."</td>
                                  <td><button class='btn btn-danger' type ='submit' name='delete' value=".$id.">Delete Route</button></td>
                                </tr>";
                                }
