      ...
      <body class="hold-transition skin-blue sidebar-mini">
          ...
          <!-- Content Wrapper. Contains page content -->
              <div class="content-wrapper">
                  ...
                  <h1>Metro<small>Station List</small></h1>
                  <ol class="breadcrumb">
                      <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                      <li class="active">Metro station List</li>
                  </ol>
              </section>
          ...
          <section class="col-md-10 col-md-offset-1 col-sm-12">
              <div class="row">
                  <div class="register-box-body">
                      <h3 class="login-box-msg">Station List</h3>
                      
                      <form action="_backend_stationList.php" method="POST">
                      ...
                      "<tr>
                        <td>".$id."</td>
                        <td>".$name."</td>
                        <td><button class='btn btn-danger' type ='submit' name='delete' value=".$id.">Delete Station</button></td>
                      </tr>";
                      }
