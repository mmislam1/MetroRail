    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- Content Wrapper. Contains page content -->
            <div class="content-wrapper">
                ...
                <h1>Add<small>New Admin</small></h1>
                <ol class="breadcrumb">
                    ...
                    <!-- Main content -->
                    <section class="col-md-8 col-md-offset-2 col-md-12">
                        <div class="row">
                            <div class="register-box-body">
                                <h3 class="login-box-msg">Add New Admin</h3>
                                <!--start Form section-->
                                <form class="form-horizontal" action="_backend_addAdmin.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-offset-4">
                                <button style="border-radius: 5px;" name="admin" type="submit" class="btn btn-warning btn-block btn-flat">Submit</button></div>
                                    </div>
                                </form>
                             <!--End Form Section-->
                            </div>
